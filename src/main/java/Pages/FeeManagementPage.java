...
public class FeeManagementPage extends BaseTest {
	...
	@FindBy(xpath = "(//*[@class='ant-modal-body'])[2]/div[2]/input")
	WebElement DiscountName;
	@FindBy(xpath = "(//*[@class='ant-modal-body'])[2]/div[3]/textarea")
	WebElement DiscountDetails;
	@FindBy(xpath = "(//*[@class='ant-modal-body'])[2]/div[4]/span/input")
	WebElement Amount;
	@FindBy(xpath="(//*[@class='ant-radio-wrapper'])[1]")
	WebElement InvoiceYes;
	@FindBy(xpath = "(//*[@class='ant-modal-body'])[2]/div[5]/button[2]")
	WebElement Save;
	...
	@FindBy(xpath = "(//*[@class='ant-modal-body'])[1]/div[2]/input")
	WebElement AdditionName;
	@FindBy(xpath = "(//*[@class='ant-modal-body'])[1]/div[3]/textarea")
	WebElement AdditionDetails;
	@FindBy(xpath = "(//*[@class='ant-modal-body'])[1]/div[4]/span/input")
	WebElement AdditionAmount;
	@FindBy(xpath = "(//*[@class='ant-modal-body'])[1]/div[5]/button[2]")
	...
	@FindBy(xpath = "(//div[@class='box-shadow'])[1]")
	WebElement ClickClass;
	...
	public void validateFeemanagementPage() throws InterruptedException {
		...
		System.out.println("Settings Button was clicked");
		WaitTil(2000);
		WebElement Processingfee = PayableBy;
		String ProcessingfeeType = Processingfee.getText();
		System.out.println(" Processingfee type is : " + ProcessingfeeType);
		String ExpectedProcessingfee = "Processing fee payable by student";
		System.out.println("ExpectedProcessingfee type is : " + ExpectedProcessingfee);
		if (ExpectedProcessingfee.equals(ProcessingfeeType)) {
			WaitTil(2000);
			PayableBy.click();
			String PayableBytype=PayableBy.getText();
			System.out.println("Selected Processingfee type is:- " + PayableBytype);
			WaitTil(2000);
			driver.findElement(By.xpath("(//*[text()='Manual'])[1]")).click();
			WaitTil(2000);
			Yes.click();
			WaitTil(1000);
			UM.popupContent();
	...
	public void overView()
	{
		...
		System.out.println("CalenderFilter was clicked");
		WaitTil(2000);
		ClickOnWeeks.click();
		System.out.println("Weeks was clicked");
		WaitTil(2000);
	...
	public void feeAmount() throws InterruptedException{
		...
		StringBuilder amount1 = new StringBuilder(1);
		for (int n = 0; n < 1; n++)
		{
		...
		DiscountName.sendKeys(name2);
		WaitTil(2000);
		DiscountDetails.sendKeys(name);
		WaitTil(2000);
		StringBuilder amount2 = new StringBuilder(1);
		for (int n = 0; n < 1; n++)
		{
			amount2.append(fee1.charAt(id1.nextInt(fee1.length())));
		}
		Amount.sendKeys(amount2);
		WaitTil(2000);
		Save.click();
	}
	...
	public void feeAmount1() throws InterruptedException{
		...
		AdditionAmount.sendKeys(amount1);
		WaitTil(2000);
		AddSaveButton.click();
		WaitTil(2000);
