...
public class ClassroomPage extends Aulas_Base.BaseTest
{
	...
	@FindBy(xpath="(//*[@class='display-flex'])[1]")
	WebElement CreateClassButton;
	@FindBy(xpath="(//*[@class='ant-input input-text-grey'])[1]")
	WebElement ClassNameField;
	@FindBy(xpath="(//*[@class='ant-input input-text-grey'])[2]")
	WebElement SectionField;
	@FindBy(xpath="//div[@class='ant-select-selector']")
	WebElement CourseSelector;
	@FindBy(xpath="//*[@class='ant-select-item ant-select-item-option ant-select-item-option-active']")
	WebElement Course1;
	@FindBy(xpath="//*[@class='r-jsb m-t-30']/button[2]")
	WebElement Createbutton;
	@FindBy(xpath="//span[text()='Add Now']")
	WebElement AddNowbutton;
	@FindBy(xpath="//span[text()='Maybe Later']")
	WebElement MaybeLaterbutton;
	@FindBy(xpath="//*[@class='ant-modal-content']/div/div/div/div[2]")
	WebElement CopyClassName;
	...
	/////**********Class Edit Icon****************///
	@FindBy(xpath="(//*[text()=' EDIT CLASSROOM'])[1]")
	WebElement ClassEditIcon;
	@FindBy(xpath="(//*[@class='m-b-20']/div/div[3])[1]")
	WebElement ClassDeleteIcon;
	@FindBy(xpath="//input[@class='ant-input input-text-grey']")
	...
	public void CreateClassRoom(String selectButton) throws InterruptedException
	{
		WaitTil(2000);
		Classrooms.click();
		WaitTil(2000);
		...
		Createbutton.click();
		WaitTil(2000);
		if(selectButton.equalsIgnoreCase("MaybeLater")) {
    		MaybeLaterbutton.click();
		}
		if(selectButton.equalsIgnoreCase("AddNow")) {
    		AddNowbutton.click();
		}
		String ele=CopyClassName.getText();
		System.out.println(ele);
		WaitTil(2000);
		SearchClass.sendKeys(ele);
		WaitTil(2000);
