...
public class SchedulePage extends Aulas_Base.BaseTest {
	...
	public void selectSubject() throws InterruptedException {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//*[@placeholder='Select Subject'])[1]")));
	...
	public void selectClass() throws InterruptedException {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//*[@placeholder='Select Class']")));
		...
		for (int i = 1; i < size; i++) {
			...
			if (nameOfClass.equalsIgnoreCase("ramesh-A")) {
				wait(3000);
