...
public class TestPage extends Aulas_Base.BaseTest {
	...
	public void clickOnCreateTest() throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='ant-btn ant-btn-default purpleBtnWrap radius-100 purpleButtonHoverEffect']")));
		driver.findElement(By.xpath("//*[@class='ant-btn ant-btn-default purpleBtnWrap radius-100 purpleButtonHoverEffect']")).click();
	...
	public void chooseTestType(String testtype) throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//*[@class='ant-btn ant-btn-default purpleBtnWrap radius-100 purpleButtonHoverEffect'])[2]"))
				.click();
	...
	public void enterDetailsOfTest() throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//*[@class='ant-select-selection-search-input'])[1]")).sendKeys("a");
		Thread.sleep(2000);
		// select examinar
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//*[@class='ant-select-item-option-content'])[12]")));
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//*[@class='ant-select-selection-item'])[5]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//*[@class='ant-select-item-option-content'])[25]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//*[@class='ant-btn ant-btn-default purpleBtnWrap radius-100 purpleButtonHoverEffect'])[2]"))
	...
	public void fillTimeAndDate() throws InterruptedException {
		...
		driver.findElement(By.xpath("(//*[@class='ant-picker-cell-inner'])[3]")).click();
	...
	public void clickOnPublish(String YN) {
		wait(3000);
		driver.findElement(
				By.xpath("//*[@class='ant-btn ant-btn-default blueBtnWrap radius-100 m-l-20 text-xs']"))
				.click();
		if (YN.equalsIgnoreCase("YES")) {
			wait(3000);
			driver.findElement(
					By.xpath("//*[@class='ant-btn ant-btn-default purpleBtnWrap radius-100 m-l-20']")).click();
			System.out.println("Clicked on the YES button");
		} else if (YN.equalsIgnoreCase("CANCEL")) {
			wait(3000);
			driver.findElement(By.xpath("//*[@class='ant-btn ant-btn-default blankGreyBtnWrap radius-100']")).click();
	...
	public void testQuestion() {
		...
		wait(3000);
		driver.findElement(By.xpath("//*[@class='cursor-pointer test-ques-window resize-editor-img p-10 full-width']")).click();
		wait(2000);
		driver.findElement(By.xpath("//*[@class='ql-editor ql-blank']")).sendKeys("20/5");
		wait(2000);
		driver.findElement(By.xpath("//*[text( )='Save & Close']")).click();
		wait(2000);
		driver.findElement(By.xpath("//*[@placeholder='Type the answer here...']")).sendKeys("4");
		wait(2000);
		driver.findElement(By.xpath("//*[@class='cursor-pointer test-ques-window resize-editor-img p-10']")).click();
		wait(2000);
		driver.findElement(By.xpath("//*[@class='ql-editor ql-blank']")).sendKeys("50/4=4");
		wait(2000);
		driver.findElement(By.xpath("//*[text( )='Save & Close']")).click();
		wait(2000);
