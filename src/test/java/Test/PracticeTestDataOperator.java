...
import OldPages.PracticeTestPage;
import Pages.HomePage1;
import Pages.LoginClass;

public class PracticeTestDataOperator extends BaseTest{
    LoginClass LC;
    HomePage1 HP;
    PracticeTestPage PC;
	...
	public PracticeTestDataOperator () {
		super();
	}
	...
	public void setup()throws InterruptedException{
		...
		HP = LC.MobileLogin(prop.getProperty("PTDPhonenum"),prop.getProperty("OTP"));
