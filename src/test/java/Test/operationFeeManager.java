...
public class operationFeeManager extends BaseTest{
LoginClass LC;
	...
	public void setup()throws InterruptedException{
		...
		LC = new LoginClass();
		HP = LC.MobileLogin(prop.getProperty("OperationFeeManager"),prop.getProperty("OTP"));
	 }
