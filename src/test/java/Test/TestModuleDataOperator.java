...
import OldPages.RegistrationPage;
import OldPages.SchedulePage;
import OldPages.TestPage;
import Pages.HomePage1;
import Pages.LoginClass;

public class TestModuleDataOperator extends Aulas_Base.BaseTest {
	LoginClass LC;
	...
	public void setup() throws InterruptedException {
		...
		HP = LC.MobileLogin(prop.getProperty("TMDPhonenum"), prop.getProperty("OTP"));
	...
	@Test(priority=1)
	public void createTestDataOp() throws InterruptedException {
		wait(3000);
		System.out.println("Create test using data operator credentials is started");
		TP.clickOnTestButton();
		TP.clickOnCreateTest();
		TP.chooseTestType("Objective");
		TP.enterDetailsOfTest();
		TP.fillTimeAndDate();
		System.out.println("Create test using data operator credentials is completetd");
	}
	@Test(priority=2)
	public void createSubTestDataOp() throws InterruptedException {
		wait(3000);
		System.out.println("Create Subjective test using data operator credentials is started");
		TP.clickOnTestButton();
		TP.clickOnCreateTest();
	...
	@Test(priority = 3)
	public void editDetailsDataOp() throws InterruptedException {
		Thread.sleep(3000);
	...
	@Test(priority = 4)
	public void cloneDataOp() throws InterruptedException {
		Thread.sleep(3000);
