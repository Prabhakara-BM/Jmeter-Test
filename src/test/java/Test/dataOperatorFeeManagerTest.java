...
public class dataOperatorFeeManagerTest extends BaseTest{
LoginClass LC;
	...
	public dataOperatorFeeManagerTest () {
		super();
	}
	...
	public void setup()throws InterruptedException{
		...
		LC = new LoginClass();
		HP = LC.MobileLogin(prop.getProperty("DataOperatorFeeManager"),prop.getProperty("OTP"));
	 }
