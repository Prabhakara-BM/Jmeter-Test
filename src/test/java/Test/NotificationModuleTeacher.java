...
import OldPages.NotificationPage;
import OldPages.SchedulePage;
import Pages.HomePage1;
import Pages.LoginClass;

public class NotificationModuleTeacher extends Aulas_Base.BaseTest {
	LoginClass LC;
	...
	public NotificationModuleTeacher() {
		super();
	}
	...
	public void setup() throws InterruptedException {
		...
		HP = LC.MobileLogin(prop.getProperty("Np"), prop.getProperty("OTP"));
