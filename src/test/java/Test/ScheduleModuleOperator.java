...
public class ScheduleModuleOperator extends Aulas_Base.BaseTest {
	LoginClass LC;
	...
	public void setup() throws InterruptedException {
		...
		HP = LC.MobileLogin(prop.getProperty("SMOPhonenum"), prop.getProperty("OTP"));
