...
public class ScheduleModuleTeacher extends Aulas_Base.BaseTest {
	LoginClass LC;
	...
	public void setup() throws InterruptedException {
		...
		HP = LC.MobileLogin(prop.getProperty("SMTPhonenum"), prop.getProperty("OTP"));
