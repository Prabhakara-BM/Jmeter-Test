...
public class UserManagementOAdminTest extends BaseTest {
	...
	public UserManagementOAdminTest() {
		super();
	}
	...
	public void setup() throws InterruptedException {
		...
		HP = UM.addaUserPrev("Operation", "Priv1", "NoPriv", "NoPriv", "NoPriv", "NoPriv", "NoPriv",  prop.getProperty("DefaultOTP"));
		WaitTil(2000);
