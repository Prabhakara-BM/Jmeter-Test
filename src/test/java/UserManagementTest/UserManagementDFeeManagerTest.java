...
public class UserManagementDFeeManagerTest extends BaseTest {
	...
	public UserManagementDFeeManagerTest() {
		super();
	}
	...
	public void setup() throws InterruptedException {
		...
		HP = UM.addaUserPrev("DataOperator", "NoPriv", "NoPriv", "Priv3", "NoPriv", "NoPriv", "NoPriv",  prop.getProperty("DefaultOTP"));
		WaitTil(2000);
