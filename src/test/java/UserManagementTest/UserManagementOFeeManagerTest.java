...
public class UserManagementOFeeManagerTest extends BaseTest {
	...
	public UserManagementOFeeManagerTest() {
		super();
	}
	...
	public void setup() throws InterruptedException {
		...
		HP = UM.addaUserPrev("Operation", "NoPriv", "NoPriv", "Priv3", "NoPriv", "NoPriv", "NoPriv",  prop.getProperty("DefaultOTP"));
		WaitTil(2000);
