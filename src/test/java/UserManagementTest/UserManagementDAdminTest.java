...
public class UserManagementDAdminTest extends BaseTest {
	...
	public UserManagementDAdminTest() {
		super();
	}
	...
	public void setup() throws InterruptedException {
		...
		HP = UM.addaUserPrev("DataOperator", "Priv1", "NoPriv", "NoPriv", "NoPriv", "NoPriv", "NoPriv",  prop.getProperty("DefaultOTP"));
		WaitTil(2000);
